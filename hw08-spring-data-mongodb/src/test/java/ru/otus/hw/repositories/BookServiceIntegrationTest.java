...
class BookServiceIntegrationTest {
    ...
    private void initTestData() {
        ...
        Book book1 = new Book("707f1f77bcf86cd799439031", "BookTitle_1", author1, genre1, List.of());
        Book book2 = new Book("707f1f77bcf86cd799439032", "BookTitle_2", author2, genre2, List.of());
        Book book3 = new Book("707f1f77bcf86cd799439033", "BookTitle_3", author3, genre3, List.of());
    ...
    void shouldDeleteBookById() {
        assertThat(bookRepository.findById("707f1f77bcf86cd799439031")).isPresent();

        bookService.deleteById("707f1f77bcf86cd799439031");

        assertThat(bookRepository.findById("707f1f77bcf86cd799439031")).isEmpty();
    }
}
